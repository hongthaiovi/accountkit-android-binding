...
A Xamarin.Android binding library for [AccountKit](https://developers.facebook.com/docs/accountkit) library.
...
Plz follow its official guide [here](https://developers.facebook.com/docs/accountkit/android).
